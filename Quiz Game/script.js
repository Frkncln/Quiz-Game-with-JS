...
var quizController = (function() {
    ...
    // 305
    var adminFullName = ['Furkan', 'Celen'];
    // 282
            ...
            if(newQuestText.value !== "") {
                ...
                if(optionsArr.length > 1) {
                    ...
                    // 61
                        ...
                        // 62
                        alert('You missed to check correct answer, or you checked answer without value.Please try it again');
                        //97
                        return false;
                    }
                // 56
                    ...
                    // 57
                    alert('You must insert at least two options.Please try it again');
                    // 98
                    return false;
                }
            // 53
